...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout header="Add New Item">
            ...
            <div className="max-w-2xl">
                <div className="mb-6">
                    ...
                    <p className="text-[#404944] mt-1">
                        Register a new state-owned asset into the system.
                    </p>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-5">
                        <Field label="Item Name" error={errors.nama_barang}>
                            <input
                                ...
                                placeholder="e.g. Mobil Avanza, Auditorium"
                            />
                        </Field>
                        ...
                        <Field label="Location" error={errors.lokasi}>
                            <input
                                ...
                                placeholder="e.g. Gedung S1 Lantai 2, Garasi Utama"
                            />
                        </Field>
                        ...
                        <div className="flex gap-3 pt-2">
                            ...
                            <Link
                                ...
                                className="flex items-center gap-2 bg-slate-100 text-slate-600 px-6 py-2.5 rounded-xl font-semibold hover:bg-slate-200 transition-all"
                            >
                                Cancel
                            </Link>
                        </div>
